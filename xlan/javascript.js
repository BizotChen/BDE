...
Blockly.Arduino.i2s_media_output_device_init = function(block) {
  ...
  Blockly.Arduino.definitions_.define_ESP8266Audio_function_invoke_checkRunning_event = 'bool isDeviceRunning()\n{\n  bool isRunning=false;\n  bool looping=false;\n  String playType="mp3";\n  if (dacPlayType=="MP3"){\n    if (voiceFileExt=="wav")\n      playType="wav";\n  }\n  isRunning=((playType=="mp3")?i2sMp3->isRunning():i2sWav->isRunning());\n  if (isRunning) {\n    looping=((playType=="mp3")?i2sMp3->loop():i2sWav->loop());\n    if (!looping){\n      if (playType=="mp3")\n        i2sMp3->stop();\n      else\n        i2sWav->stop();\n      mp3Done=true;\n      ttsDone=true;\n      httpDone=true;\n      isRunning=false;\n    }\n  }\n  return isRunning;\n}\n';
...
Blockly.Arduino.i2s_media_play_loop = function(block) {
